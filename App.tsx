...
export default function App() {
  ...
  const CHECKLIST_TEXT_MAP: Record<string, string> = {
    ...
    '루틴의 핵심 = 일관성': '매일 같은 수면 루틴 유지하기',
    '적정 시작 시간': '취침 30분 전 수면 의식 시작하기',
    '자극 줄이기': '잠자기 전 TV/스마트폰 끄기',
    '적정 볼륨 50dB': '화이트노이즈 볼륨 확인하기',
    '끊는 시기와 방법': '화이트노이즈 점차 줄이기',
    '거리 유지하기': '화이트노이즈 기기 거리 확인하기',
    '최적 온도 20-22도': '실내 온도 20-22도 맞추기',
    '습도 50-60% 유지': '습도 50-60% 유지하기',
    '체온 확인법': '아이 체온 확인하기',
    ...
    '권장 시작 시기': '이유식 시작 시기 확인하기',
    '이유식 시작 신호': '이유식 시작 신호 관찰하기',
    '첫 이유식은 쌀미음': '쌀미음으로 시작하기',
    '소고기가 최고': '소고기 이유식 만들기',
    '비타민C와 함께': '철분+비타민C 함께 먹이기',
    '우유와 분리해서': '이유식과 분유 시간 분리하기',
    '새 음식은 오전에': '새 식재료는 오전에 시도하기',
    '응급 상황': '알레르기 응급상황 대처법 숙지하기',
    ...
    '스킨십의 힘': '스킨십 자주 해주기',
    '반응해주기': '아이 표정에 반응해주기',
    '감정 먼저 인정': '아이 감정 먼저 인정해주기',
    '요구 들어주지 않기': '떼쓸 때 요구 들어주지 않기',
    '기다려주기': '진정 시간 기다려주기',
    '점진적 연습': '분리 연습 시간 늘리기',
    '몰래 사라지기 금지': '외출 시 꼭 인사하기',
    ...
    '1-2개월 차이는 정상': '발달 개인차 인정하기',
    '이럴 땐 상담 필요': '필요시 소아과 상담받기',
    '매일 자극 주기': '매일 10분 놀아주기',
    '하루 목표': '터미타임 하루 15-30분 하기',
    '흥미 유발': '장난감으로 고개 들기 유도하기',
    '엄마 가슴 위에서': '엄마 가슴 위 터미타임 시도하기',
    '월령별 놀이': '월령별 소근육 놀이하기',
    '일상이 놀이': '일상 활동으로 소근육 발달시키기',
    '집게 손가락 연습': '집게손가락으로 집기 연습하기',
    ...
    '준비 신호 체크': '배변 훈련 준비 신호 확인하기',
    '적정 시기': '아이 준비 상태 관찰하기',
    
    // 일반/격려
    '육아는 함께할 때 더 쉬워져요': '주변에 도움 요청하기',
    '오늘도 수고하셨어요': '오늘 하루 스스로 칭찬하기',
    '당신은 좋은 부모예요': '스스로 격려하기',
    '잠깐 쉬어가세요': '잠깐 휴식 취하기',
    '부모도 쉬어야 해요': '나만의 휴식 시간 갖기',
    '도움을 요청하세요': '주변에 도움 요청하기',
  ...
  const dynamicChecklist = React.useMemo(() => {
    const allTips = messages
      ...
      .filter(tip => isValidForChecklist(tip.title)); // 체크리스트에 적합한 것만
